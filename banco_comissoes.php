 ...
 */
register_activation_hook('banco_comissoes', 'banco_comissoes_module_activation');
...
function commission_module_init_menu_items() {
	...
	if (has_permission('commission', '', 'view') || has_permission('commission', '', 'view_own') || has_permission('commission_applicable_staff', '', 'view') || has_permission('commission_policy', '', 'view')) {
		$CI->app_menu->add_sidebar_menu_item('banco_comissoes', [
    'name'     => 'Propostas e Comissões',
    'slug'     => 'banco_comissoes',
    'icon'     => 'fa fa-percent',
    'href'     => admin_url('banco_comissoes'),
    'position' => 30,
]);
